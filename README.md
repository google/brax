...
*   Learning algorithms that leverage the differentiability of the simulator, such as [analytical policy gradients](https://github.com/google/brax/blob/main/brax/training/dto.py).
