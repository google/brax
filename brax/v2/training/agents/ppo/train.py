...
# TODO remove duplicate ppo/train.py once jaxopt deps are sorted out
...
def train(environment: envs.Env,
  ...
  if isinstance(env, envs_v2.Env):
    wrap_for_training = wrapper.wrap_for_training
  else:
    wrap_for_training = wrappers.wrap_for_training
