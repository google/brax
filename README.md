...
*   Baseline learning algorithms such as
    [PPO](https://github.com/google/brax/blob/main/brax/training/agents/ppo/train.py),
    [SAC](https://github.com/google/brax/blob/main/brax/training/agents/sac/train.py),
    [ARS](https://github.com/google/brax/blob/main/brax/training/agents/ars/train.py), and
    [evolutionary strategies](https://github.com/google/brax/blob/main/brax/training/agents/es/train.py).
*   Learning algorithms that leverage the differentiability of the simulator, such as [analytic policy gradients](https://github.com/google/brax/blob/main/brax/training/agents/apg/train.py).
